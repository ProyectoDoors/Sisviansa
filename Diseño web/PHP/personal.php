...
if (
    ...
    try {
        ...
        if ($select_email_stmt->rowCount() > 0) {
            ...
            $insert_user_stmt = $db->prepare("INSERT INTO usuario (ID_Usuario, `E-mail`, Contraseña, Rol) VALUES (:nuevo_id_cliente, :email, :Contrasena, :rol)");
            $insert_user_stmt->bindParam(":email", $email);
            $insert_user_stmt->bindParam(":rol", $rol);
